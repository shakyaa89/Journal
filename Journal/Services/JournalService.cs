...
namespace Journal.Services
{
    public class JournalService : IJournalService
    {
        ...
        public async Task<List<JournalEntry>> GetAllJournalsAsync(int userId) => await _journalRepository.FetchJournalEntriesAsync(userId);

        // Get single journal by ID
        public async Task<JournalEntry?> GetJournalByIdAsync(int id) => await _journalRepository.FetchJournalByIdAsync(id);
