...
namespace Journal.Services
{
    public interface IJournalService
    {
        ...
        Task<JournalEntry?> UpdateJournalEntryAsync(int id,string title,string content,string mood,string secondaryMood1,string secondaryMood2, List<string>? tags, int userId, DateTime updatedAt);
    }
}
